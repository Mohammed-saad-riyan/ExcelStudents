  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6 lg:space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-500">Manage on-platform exams and Google Form quizzes</p>
            </div>
            <div className="flex gap-2">
              <button
                onClick={() => router.push("/admin/exams/create")}
                className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 bg-gradient-to-r from-[#075aae] to-[#0ea5e9] text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-semibold rounded-xl hover:bg-gray-200 transition-all"
              >
        ...
        {/* Create Form for Google Form exams */}
        <AnimatePresence>
          {showForm && (
            <motion.div
            ...
            >
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-gray-900">Add New Quiz (Google Form)</h3>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 mt-1.5">
                            ...
                            <span className="text-xs text-gray-400 flex items-center gap-1">
                              <Award className="w-3 h-3" /> {exam.totalMarks} marks
                            </span>
                            <span className="text-xs text-gray-400 flex items-center gap-1">
                              <Users className="w-3 h-3" /> {exam._count.attempts} attempts
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-[#075aae] bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white bg-[#075aae] rounded-lg hover:bg-[#064a8e] transition-colors"
                        >
        ...
        <div>
          ...
          {googleFormExams.length === 0 && !showForm ? (
            <div className="bg-white rounded-2xl p-12 text-center border border-gray-100">
              <BookOpen className="w-12 h-12 text-gray-300 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-gray-900">No quizzes yet</h3>
              <p className="text-gray-500 mt-1">Click &quot;Add Quiz&quot; to create a Google Form quiz.</p>
            </div>
          ) : (
            <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          {exam.formUrl ? (
                            ...
                            <span className="text-xs text-amber-500 mt-1 block">No form URL</span>
                          )}
                        </div>
                      </div>
