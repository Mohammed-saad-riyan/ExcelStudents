      ...
      <div className="ml-64 min-h-screen bg-[#fafbfc]">
        <div className="px-8 py-6">
          ...
          <div className="mb-8">
            ...
            >
              <div>
                <h1 className="text-display text-2xl text-gray-900 mb-1">
            ...
            <div className="grid grid-cols-4 gap-4">
              {quickLinks.map((link, i) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="card-elevated rounded-xl p-5 block group relative overflow-hidden"
                  >
                    {link.count !== null && link.count > 0 && (
                      <div className="absolute top-3 right-3 w-5 h-5 bg-[#075aae] text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                        {link.count}
                      </div>
                    )}
